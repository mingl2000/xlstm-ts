...
FILE_NAME = 'SPX_daily'
FILE_NAME = '000001SS_daily' #69.25%
STOCK = 'SS 000001'
#FILE_NAME = '399001.sz_daily'  # f1  70.19%
#STOCK = 'SZ 399001'  
...
df = pd.read_csv(file_path, header=0, index_col=0, skiprows=[1,2])
...
df=df[(df.index >= datetime.datetime.strptime(START_DATE, '%Y-%m-%d')) & (df.index <= datetime.datetime.strptime(END_DATE, '%Y-%m-%d'))]
